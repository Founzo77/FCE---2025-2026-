...
namespace fge
{
    ...
    public:
        ...
        void share(const uint64_t index);
        bool free(const uint64_t index);
        ...
        {
            throwIfFailed(index < m_nbMaxElements, "SafeCompactStackAllocator::get: Index invalide");
